...
Router::prefix('api', function ($routes) {
    ...
    $routes->resources('Assigned');
    $routes->resources('MeetingNotes');
...
Router::scope('/', function (RouteBuilder $routes) {
     ...
     */
    // ['controller' => 'schedules', 'action' => 'schedule-print']
    $routes->connect('/', ['controller' => 'assigned', 'action' => 'schedule-edit']);

    /**
     * ...and connect the rest of 'Pages' controller's URLs.
     */

		$routes->connect('/pages/blank', ['controller' => 'Pages', 'action' => 'show']);
