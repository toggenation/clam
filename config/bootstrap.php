 ...
 */
//Configure::config('clam', new Cake\Core\Configure\Engine\IniConfig());
Configure::config('clam', new PhpConfig());
Configure::load('clam', 'clam');
//Configure::write('CLAM.itried', 'james');
//Configure::write('MORESETTINGS.setting1', 'CL&M Creator');
