...
class AssignedFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'part_title' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'assistant_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'part_meeting_idx' => ['type' => 'unique', 'columns' => ['meeting_id', 'part_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'part_id' => 1,
            'minutes' => 1,
            'part_title' => 'Lorem ipsum dolor sit amet',
            'meeting_id' => 1,
            'person_id' => 1,
            'assistant_id' => 1
        ],
