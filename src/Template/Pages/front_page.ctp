<h3>
    Christian Life and Ministry Schedule Creator
</h3>
...
<p>Once you have the priliminaries completed you can create CL&M Schedule</p>


<p>Each CL&M Schedule contains the following. They are configured on the Create menu</p>

<ol>
    <li class="nav-item">A Schedule - Using your CL&M Workbook enter the start and end dates of this schedule</li>
    <li class="nav-item">Meetings - You need to specify the meeting dates for the schedule you created in the previous step</li>
    <li class="nav-item">Assign People to Parts - Each meeting part needs one or more people assigned</li>
