    ...
    <div id="content">
        ...
        <div class="row">
            <div class="columns large-6">
                ...
                <ul>
                    <li class="nav-item">To change the content of this page, edit: src/Template/Pages/home.ctp.</li>
                    <li class="nav-item">You can also add some CSS styles for your pages at: webroot/css/.</li>
                </ul>
            </div>
            <div class="columns large-6">
                <h3>Getting Started</h3>
                <ul>
                    <li class="nav-item"><a target="_blank" href="http://book.cakephp.org/3.0/en/">CakePHP 3.0 Docs</a></li>
                    <li class="nav-item"><a target="_blank" href="http://book.cakephp.org/3.0/en/tutorials-and-examples/bookmarks/intro.html">The 15 min Bookmarker Tutorial</a></li>
                    <li class="nav-item"><a target="_blank" href="http://book.cakephp.org/3.0/en/tutorials-and-examples/blog/blog.html">The 15 min Blog Tutorial</a></li>
                </ul>
                <p>
            </div>
        </div>
            ...
            <div class="columns large-12">
                ...
                <ul>
                    <li class="nav-item">
                        ...
                        <ul><li class="nav-item">Live chat about CakePHP</li></ul>
                    </li>
                    <li class="nav-item">
                        <a href="https://github.com/cakephp/cakephp/issues">CakePHP Issues</a>
                        <ul><li class="nav-item">CakePHP issues and pull requests</li></ul>
                    </li>
                    <li class="nav-item">
                        <a href="https://groups.google.com/group/cake-php">CakePHP Google Group</a>
                        <ul><li class="nav-item">Community mailing list</li></ul>
                    </li>
                </ul>
                ...
                <ul>
                    <li class="nav-item">
                        ...
                        <ul><li class="nav-item">Quick Reference</li></ul>
                    </li>
                    <li class="nav-item">
                        <a href="http://book.cakephp.org/3.0/en/">CakePHP Documentation</a>
                        <ul><li class="nav-item">Your Rapid Development Cookbook</li></ul>
                    </li>
                    <li class="nav-item">
                        <a href="http://bakery.cakephp.org">The Bakery</a>
                        <ul><li class="nav-item">Everything CakePHP</li></ul>
                    </li>
                    <li class="nav-item">
                        <a href="http://plugins.cakephp.org">CakePHP plugins repo</a>
                        <ul><li class="nav-item">A comprehensive list of all CakePHP plugins created by the community</li></ul>
                    </li>
                    <li class="nav-item">
                        <a href="https://github.com/cakephp/">CakePHP Code</a>
                        <ul><li class="nav-item">For the Development of CakePHP Git repository, Downloads</li></ul>
                    </li>
                    <li class="nav-item">
                        <a href="https://github.com/FriendsOfCake/awesome-cakephp">CakePHP Awesome List</a>
                        <ul><li class="nav-item">A curated list of amazingly awesome CakePHP plugins, resources and shiny things.</li></ul>
                    </li>
                    <li class="nav-item">
                        <a href="http://www.cakephp.org">CakePHP</a>
                        <ul><li class="nav-item">The Rapid Development Framework</li></ul>
                    </li>
                </ul>
                ...
                <ul>
                    <li class="nav-item">
                        ...
                        <ul><li class="nav-item">Promoting development related to CakePHP</li></ul>
                    </li>
                    <li class="nav-item">
                        <a href="http://training.cakephp.org/">CakePHP Training</a>
                        <ul><li class="nav-item">Learn to use the CakePHP framework</li></ul>
                    </li>
                    <li class="nav-item">
                        <a href="http://certification.cakephp.org/">CakePHP Certification</a>
                        <ul><li class="nav-item">Become a certified CakePHP developer</li></ul>
                    </li>
                </ul>
            </div>
        </div>
