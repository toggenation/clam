<div class="row">
    <div class="col-lg-2"><ul class="nav flex-column nav-pills">
        ...
        <li class="nav-item"><?= $this->Html->link(
            __('Edit Role'), ['action' => 'edit', $role->id], ['class' => 'nav-link' ]) ?> </li>
        <li class="nav-item"><?= $this->Form->postLink(__('Delete Role'), ['action' => 'delete', $role->id],
...
<div class="col-lg-10">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th><?= __('Assistant') ?></th>
            <td><?= h($role->assistant) ?></td>
        </tr>

    </table>
    <div class="related">
        <h4><?= __('Related Parts') ?></h4>
        <?php if (!empty($role->parts)): ?>
        <table class="table table-bordered table-condensed table-striped table-responsive">
            ...
            <?php foreach ($role->parts as $parts): ?>
            <tr>
                <td><?= h($parts->id) ?></td>
    ...
    <div class="related">
        ...
        <table class="table table-bordered table-condensed table-striped table-responsive">
            ...
            <?php foreach ($role->people as $people): ?>
            <tr>
                <td><?= h($people->id) ?></td>
